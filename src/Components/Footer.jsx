...
const Footer = () => {
  ...
  const [showBanner, setShowBanner] = useState(!localStorage.getItem("CristO"));
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 footer-contact">
                <div className="copyright">
                  ...
                  <div className="credits">
                    <a
                      href="https://www.facebook.com/CristOReligious/"
                      target="_blank"
                      rel="noreferrer">
                      <svg
                        stroke="currentColor"
                    ...
                    <a
                      href="https://www.linkedin.com/company/81849391/admin/feed/posts/"
                      target="_blank"
                      rel="noreferrer">
                      <svg
                        stroke="currentColor"
                    ...
                    <a
                      href="https://www.instagram.com/cristo_erp/"
                      target="_blank"
                      rel="noreferrer">
                      <svg
                        stroke="currentColor"
                    ...
                    <a
                      href="https://twitter.com/Boscosoft1"
                      target="_blank"
                      rel="noreferrer">
                      <svg
                        stroke="currentColor"
              ...
              <div className="col-lg-3 col-md-6 footer-links">
                ...
                <ul>
                  ...
                  <div className="title-footer">
                    <h4 style={{ marginBottom: "auto" }}>Support</h4>
                  </div>
                  <br />
                  <p id="footbottom">
