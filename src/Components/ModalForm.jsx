              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="trial-process">
                    <h5>
                      <b>Experience it Now:</b>
                    </h5>
                    <p>
                      Embark on your Demo journey by following these simple
                      steps:
                    </p>
                    &#10004; Fill out the form to your left.
                    <br />
                    &#10004; Tap the "Activate Free Demo" button below.
                    <br />
