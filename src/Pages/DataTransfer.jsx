        ...
        <div className="container w-container">
          <div className="flex-tl home-header x-margin-btm switch">
            <div className="hero-heading">
              <h1>We'll Move your data into Parokia for you</h1>
              <p className="paragraph-lrg">
                Transferring your data to a new system can be a hassle. That's
                why we'll do it for you at no extra charge when you sign up.
                Prefer to do it yourself? Parokia Church Management™ makes it
                easy to import your current data; whether you are using another
                church management tool or simply a handful of Excel files, you
                can bulk import your data to be up and running in moments.
              </p>
        ...
        <div className="container w-container">
          <div className="grid-3 gap-lrg">
            <div
              ...
              <p>
                Our team will be happy to help you retrieve your current data.
                We can provide instructions or remotely connect to your computer
                to export your data from your previous system for you. And as
                always, there's no additional charge for this.
              </p>
            </div>
            <div
              ...
              <img
                ...
                className="img-product"
              />
              <h4>We'll import your existing data into Parokia for you</h4>
              <p>
                Our team will take your previous data and import it into Parokia
                , all without any additional costs. Our import team has seen
                nearly every format imaginable and are pros at converting data
                from previous systems into Parokia .
              </p>
            </div>
            <div
              ...
              <p>
                If you're technically minded and would prefer to handle moving
                into Parokia yourself instead of having us do it for you, we'd
                love to support you. We have detailed transfer instructions for
                nearly every ChMS out there and you're always welcome to ask us
                questions.
                <br />
              </p>
            </div>
